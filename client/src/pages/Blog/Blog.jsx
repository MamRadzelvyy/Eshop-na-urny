...
const otherPosts = [
  {
    ...
    image: "../../src/assets/images/Zavěť.png",
    link: "/dusicky",
    excerpt: "Dušičky, neboli Památka zesnulých, jsou tradiční svátek, během kterého si lidé připomínají své blízké..."
  },
  {
    title: "Průvodce pohřebními obřady",
    image: "../../src/assets/images/Zavěť.png",
    link: "/pohrebni-obrady",
    excerpt: "Vše, co potřebujete vědět o organizaci pohřebních obřadů, od výběru kytice po průběh ceremoniálu..."
  },
  {
    title: "Alternativní způsoby posledního rozloučení",
    image: "../../src/assets/images/Zavěť.png",
    link: "/alternativni-pohreb",
    excerpt: "Hledáte jiné možnosti než klasický pohřeb? Seznamte se s ekologickými a netradičními způsoby rozloučení..."
  },
  {
    title: "Alternativní způsoby posledního rozloučení",
    image: "../../src/assets/images/Zavěť.png",
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="flex items-center justify-between gap-3 mb-4">
          ...
          <h1 className="text-4xl font-bold text-center flex-none my-auto h-full">Blog</h1>
          <div className="bg-gray-300 h-[1px] w-full" />
        </div>
          <div className="text-center text-2xl font-bold my-6">S čím potřebujete poradit?</div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-6 max-w-6xl mx-auto">
            {blogPosts.map((post, index) => (
              <Link key={index} to={post.link} className="block">
                ...
                >
                  <img src={post.image} alt={post.title} className="w-full h-64 object-cover brightness-75"  />
          ...
          <div className="text-center text-4xl font-bold my-6">Nejnovější příspěvky</div>
      </div>
