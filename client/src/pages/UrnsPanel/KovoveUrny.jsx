...
export default function KovoveUrny() {
  ...
  useEffect(() => {
    const loadUrns = async () => {
      ...
      if (data.status === 200) {
        const filteredUrns = data.payload.filter((urn) => urn.material === "Kovové urny");
  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto p-6">
        <h1 className="text-4xl font-bold text-center mb-6">Kovové urny</h1>
...
<div className="flex justify-center gap-4 mt-4">
  ...
  <Button className="px-7 py-3 bg-green-200 text-green-900 hover:bg-green-300">
    <ShoppingCart className="w-5 h-5" />
            ...
            <p className="text-center text-gray-500 col-span-full">Žádné kovové urny nebyly nalezeny.</p>
          )}
        </div>
      </div>
      <Footer />
