    ...
    >
      <div className="mb-4">
        ...
        <input type="text" name="name" value={formData.name} onChange={handleChange} 
          className="w-full p-2 border rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:ring focus:ring-blue-300" required />
      </div>
      <div className="mb-4">
      ...
      <div className="mb-4">
        ...
        <textarea name="message" value={formData.message} onChange={handleChange} 
          className="w-full p-2 border rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:ring focus:ring-blue-300" rows="4" required></textarea>
      </div>
